return {
	...
	config = function()
		...
		local on_attach = function(client, bufnr)
			...
			keymap.set("n", "<leader>d", vim.diagnostic.open_float, { desc = "Show line diagnostic" }) -- show diagnostics for line
			...
			keymap.set("n", "K", vim.lsp.buf.hover, { desc = "Show documentation under cursor" }) -- show documentation for what is under cursor
